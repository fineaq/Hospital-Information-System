  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="history.php?id=<?php echo $id=$_GET['id'];?>">Histori Pemeriksaan</a></li>
...
include '../koneksi.php';
    ...
    while($c=mysqli_fetch_array($get_id)){
      $nama = $c['nama'];
      $daftar = $conn->query ("select * from rekam_medis_header where nama_pasien = '$nama' ");
...
<div class="container">
<h3 class="text-center" >Histori Pemeriksaan</h3><br><br>
